...
<body>
  ...
  <main id="main" class=" bg-danger">
  		...
  		<div id="login-right" class="bg-danger">
  			<div class="w-100">
			<!-- <h4 class="text-white text-center"><b>Mainali Samaj Blood <br> Bank Management System</b></h4> -->
			<br>
			<br>
  				...
  				<div class="card-body">
  					<form id="login-form" >
  						<div class="form-group">
							<h3>Login To Continue!!</h3> <br> <br>
							<h5> Blood Bank Management System</h5> <br>
