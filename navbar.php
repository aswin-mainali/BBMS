...
<nav id="sidebar" class='mx-lt-5 bg-danger' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users text-danger"></i></span> Users</a> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br>
				<a href="index.php?page=site_settings" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-code text-danger"></i></span> About Developer 🖤 </a> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br>
			<?php endif; ?>
		</div>
